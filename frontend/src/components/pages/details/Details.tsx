...
export const DetailsUIWithoutContext: React.FC<Props> = ({
  ...
  const isL = isLayout !== null && isLayout !== undefined ? isLayout : true;
...
export const DetailsUI: React.FC<Props> = ({ detailsId, parentId, language, isLayout }) => {
  return (
